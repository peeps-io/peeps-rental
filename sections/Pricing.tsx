...
const plans = [
  {
    ...
    features: [
      "Up to 10 Apartments",
      "Up to 5 Members and roles",
      "Up to 20 tenants managed",
      "48-hour support response time",
      "Up to 10 notice creations per month",
  ...
  },
  {
    ...
    features: [
      "Up to 50 Apartments",
      "Up to 10 Members and roles",
      "unlimited number of tenants",
      "24-hour support response time",
      "Access to offline receipts",
      "Access to lease agreements offline",
      "Access to tenant History",
      "Advance reports",
      "Priority support",
      "unlimited notice creation",
      "Ads free",
      "Active Community support",
    ],
  ...
  },
  {
    ...
    features: [
      ...
      "Custom contracts and lease agreements",
    ],
